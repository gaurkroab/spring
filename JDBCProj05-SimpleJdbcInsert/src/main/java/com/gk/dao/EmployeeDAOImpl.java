...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	public int insert(Employee emp) {
		...
		// create Map object having col name values
		Map<String,Object> colMap=Map.of("EMPNO",emp.getEmpno(),"ENAME",emp.getEname(),"JOB",emp.getJob(),"SAL",emp.getSal());
	...
	public int insert(Employee emp) {
		...
		// (col names and java bean property names must be same)
